    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[80vh] overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2075&q=80')`
          }}
        />
