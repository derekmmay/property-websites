          ...
          <div className="text-center text-white z-10 max-w-6xl mx-auto px-4 pointer-events-auto">
            ...
            <div className="mb-8">
              <Button
                ...
                variant="outline"
                className="border-2 border-white/80 text-black bg-white hover:bg-transparent hover:text-white px-8 py-3 text-sm font-light tracking-[0.2em] uppercase transition-all duration-500 hover:scale-105 backdrop-blur-sm"
              >
