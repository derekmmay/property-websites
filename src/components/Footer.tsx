        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <nav className="space-y-3">
              ...
              <Link to="/location" className="block text-slate-300 hover:text-white transition-colors">
                Location
              </Link>
              <Link to="/lifestyle" className="block text-slate-300 hover:text-white transition-colors">
                Lifestyle
              </Link>
              <Link to="/schools" className="block text-slate-300 hover:text-white transition-colors">
                Schools
              </Link>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">(949) 949-9499</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-slate-400" />
                <span className="text-slate-300">susan@compass.com</span>
              </div>
